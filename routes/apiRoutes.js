...
router.post("/api/user-profile/archive/:rentId", authenticate, UserController.updateDogRentals);
router.get("/api/userRate/:userId", authenticate, UserController.getDogRatingByUser);
